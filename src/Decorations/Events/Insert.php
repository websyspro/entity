...
/**
 * PHP attribute for defining default value on entity property during INSERT operations.
 * Automatically sets property value when new entity is created.
...
class Insert
{
  ...
  /**
   * Initializes insert event with default value or value generator class.
   * 
  ...
  /**
   * Retrieves the value to be used during insert operation.
   * Calls Get() method if value is a class, otherwise returns static value.
   * 
   * @return mixed Value to set on property during insert
   */
  public function Get(
  ): mixed {
